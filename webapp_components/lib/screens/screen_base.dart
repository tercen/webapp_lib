...
class ComponentEntry {
  ...
  ComponentEntry(this.component, this.componentName, this.componentType, {this.order = 0});
}
...
mixin ScreenBase {
  ...
  List<Component> getAllComponents() {
    ...
    for (var block in componentBlocks.values) {
      components.addAll(block.map((ce) => ce.component).whereType<Component>() );
    }
  ...
  List<Component> getComponentsPerBlock(String blockId) {
    ...
    return componentEntryList.map((e) => e.component).whereType<Component>().toList();
  }
