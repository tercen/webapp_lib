...
class MultiCheckComponent with ChangeNotifier, ComponentBase implements SerializableComponent {
  ...
  MultiCheckComponent(id, groupId, componentLabel, {this.columns = 5, this.hasSelectAll = false, this.selectAll = false, this.columnWidth, this.saveState = true}){
    super.id = id;
