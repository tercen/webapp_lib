...
// class ActionListComponent extends ListComponent with StateComponent {
...
//   Widget createEntry(List<dynamic> values, List<ListAction> actions, int rowIdx, WebappTable rowValues){
...
//         InkWell(
//           onTap: () async {
//             await (actions[i].callAction(rowValues));
//             notifyListeners();
...
//     row = collapsibleWrap2(rowIdx, row, rowValues[detailColumn].first);
...
//   List<int> getSortedRowIdx(WebappTable tbl){
//     var idxList =  List<int>.generate(tbl.nRows, (i) => i);
//     if( sortingCol != ""){
//       var values = tbl.columns[sortingCol]!.toList();
