...
class HierarchyListComponent2 with
        ChangeNotifier,
        ComponentBase,
        ComponentCache,
        ComponentInfoBox,
  ...
  HierarchyListComponent2( id, groupId, componentLabel, this.dataFetchCallback, {cache = true, this.selectionBehavior = SelectionBehavior.none}) {
    super.id = id;
