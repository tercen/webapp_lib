...
//   List<Component> componentsFromSettings(
//       {String? mode, String? stepId, String? section}) {
...
//       var settingId =
//           "${settingIdentifier()}${setting.stepId}${settingIdSeparator()}${setting.settingName}";
...
//           var comp =
//               InputTextComponent(settingId, groupId, setting.settingName);
...
//               settingId, groupId, setting.settingName,
//               columns: 5);
//           comp.setOptions(setting.options.map((e) => IdElement(e, e)).toList());
//           comp.setValue(setting.textValue
//               .split(",")
//               .map((e) => IdElement(e, e))
//               .toList());
//           comps.add(comp);
...
//         case "ListSingle":
//           var comp =
//               SelectDropDownComponent(settingId, groupId, setting.settingName);
