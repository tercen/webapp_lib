...
class FileDataService {
  ...
  Future<Schema> _createFileSchema(String fileId,
      {String separator = ","}) async {
    var fileService = FileDataService();
    var numLines = 5;
    var csvLines =
        await fileService.downloadFileLinesAsString(fileId, numLines: numLines);
  ...
  Future<String> uploadFileAsTable2(
      {required String filename,
    ...
    var inputSchema =
        await _createFileSchema(file.id, separator: getSeparator(contentType));
